...
def instructions_menu():
    ...
    start_button = Button(root, text="Back", font=("Helvetica",26), bg = "cyan4",fg = "goldenrod2", width = 17, command = instructions_command)
    start_button.place(bordermode=OUTSIDE, x=482, y=250)
